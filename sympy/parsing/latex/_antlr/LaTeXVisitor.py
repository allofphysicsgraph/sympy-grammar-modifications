...
class LaTeXVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by LaTeXParser#abs_2.
    def visitAbs_2(self, ctx:LaTeXParser.Abs_2Context):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by LaTeXParser#abs_1.
    def visitAbs_1(self, ctx:LaTeXParser.Abs_1Context):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by LaTeXParser#abs_0.
    def visitAbs_0(self, ctx:LaTeXParser.Abs_0Context):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by LaTeXParser#l_r_angle.
    def visitL_r_angle(self, ctx:LaTeXParser.L_r_angleContext):
        return self.visitChildren(ctx)
